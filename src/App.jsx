        ...
        <div className="flex justify-center items-center h-screen bg-gradient-to-r from-green-400 via-blue-500 to-purple-600">
          <div className="absolute top-4 right-4">
            <SuprSendInbox
              ...
              className="py-2 px-4 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-md hover:from-blue-600 hover:to-purple-600 transition duration-300 transform hover:scale-105 cursor-pointer"
            />
          </div>
          <div
